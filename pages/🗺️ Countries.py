...
continent_filter = st.sidebar.multiselect("Filter by continent", df['continent'].unique(),default = df['continent'].unique())
price_type_filter = st.sidebar.multiselect("Filter by price type", ['cheap', 'normal', 'expensive', 'gourmet'], default = df['price_tye'].unique())
